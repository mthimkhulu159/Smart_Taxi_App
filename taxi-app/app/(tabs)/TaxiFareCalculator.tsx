            ...
            <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false} >
              ...
              <View style={styles.section}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 15 }}>
                  ...
                  <TouchableOpacity style={[styles.actionButtonBase, { backgroundColor: '#005A9C', paddingVertical: 10, paddingHorizontal: 15 }]} onPress={handleAddRow} >
                    <Ionicons name="add" size={20} color="#FFFFFF" style={styles.actionButtonIcon} />
                    <Text style={[styles.actionButtonText, {fontSize: 14}]}>Add Row</Text>
                  </TouchableOpacity>
                </View>
                {calculations.rowCalculations.length === 0 && (<Text style={{ color: '#666', textAlign: 'center', fontStyle: 'italic', marginBottom: 20}}> Press "+ Add Row" to record payments.</Text>)}
